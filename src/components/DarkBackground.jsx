  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-white flex flex-col items-center justify-center">
        <SearchForm setWordData={setWordData} searchQuery={searchQuery} setSearchQuery={setSearchQuery} numberofWords={numberofWords} setNumberOfWords={setNumberOfWords} />
